...
🏷️  __Ana amacım gruplarda sizleri birçok özelliğim ile eğlendirmek.__

✨  __Mesela sizinle metinleri seslendirmek ya da mani söylemek gibi.__ 

❤️‍🔥  __Burçlarınızı yorumlayabilirim.__ 

👾  __/chatmode ile sohbet modunu açıp kapatabilirsiniz.__ 

📝  __Ayrıca birçok komutum var, komutlarımı öğrenmek için butonlardan yardım alabilirsin.__ 👇
"""
...
♻️  **/duyuru  –  Reklam Komutu**
♻️  **/stat  –  Bot hakkında bilgi verir**
♻️  **/block  –  Kullanıcıyı banlar veya grup**
♻️  **/unblock  –  Kullanıcının banını kaldır veya grubun**
...
♻️  **/ping  –  Bot'un ping değerini gösterir.**
"""
